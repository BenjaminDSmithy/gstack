...
describe('ship step numbering', () => {
  ...
  // by test/ship-apple-gate.test.ts), 1.5 (Upstream duplicate audit — pr-prep
  // gate), 8.1 (Plan Verification), 8.2 (Scope Drift), 9.1 (Review Army),
  // 9.2 (Findings Merge), 9.3 (Cross-review dedup), 9.4 (Fix-First and
  // persistence), 15.0 (WIP context), 15.1 (Bisectable commits),
  // 15.2 (safe optional WIP consolidation).
  const ALLOWED_SUBSTEPS = new Set(['0.9', '1.5', '8.1', '8.2', '9.1', '9.2', '9.3', '9.4', '15.0', '15.1', '15.2']);
